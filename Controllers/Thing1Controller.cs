...
namespace GIT_MVC_GROUP6B.Controllers
{
    public class Thing1Controller : Controller
    {
        private readonly GIT_MVC_GROUP6BContext _context;

        public Thing1Controller(GIT_MVC_GROUP6BContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age")] Thing1 thing1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age")] Thing1 thing1)
        {
            if (id != thing1.Id)
            {
                return NotFound();
